                    ...
                    if (accounts.containsKey(uname) && accounts.get(uname).equals(pword)) {
                        ...
                        while (true) {
                            ...
                            switch (menuChoice) {
                                ...
                                case 1:
                                    // FIX 1: hitting the limit just shows a warning and loops back
                                    if (messagesSentThisSession >= numMessages) {
                                        System.out.println("You have reached your message limit of "
                                                           + numMessages + ". Use the menu to view "
                                                           + "or manage your messages.");
                                        break;
                                    }
                                    ...
                                    // FIX 1 cont: no break messageLoop — just tell them and stay in menu
                                    if (messagesSentThisSession >= numMessages) {
                                        System.out.println("\nAll " + numMessages
        ...
        while (running) {
            ...
            switch (sub) {
                ...
                case "e":
                    ...
                    break;
                case "f":
                    // FIX 2: call displayReport which now shows ALL messages
